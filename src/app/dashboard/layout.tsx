...
export default function DashboardLayout({
  ...
  const menuItems = [
    ...
    { name: "Equipamentos", icon: FiBriefcase, path: "/dashboard/equipamento" },
    {
      ...
      icon: FiBriefcase,
      path: "/dashboard/tipoManutencao",
    },
    { name: "KPI", icon: FiBriefcase, path: "/dashboard/kpi" },
    {
      name: "Grupos de Defeito",
      icon: FiBriefcase,
      path: "/dashboard/grupoDeDefeito",
    },
    {
      name: "Grupos de Defeito x Equipamentos",
      icon: FiBriefcase,
      path: "/dashboard/grupoDefeitoEquipamento",
    },
    {
      name: "Subgrupos de Defeito",
      icon: FiBriefcase,
      path: "/dashboard/subgrupoDefeito",
    },
    { name: "Defeitos", icon: FiBriefcase, path: "/dashboard/defeito" },
    {
      name: "Notas Plano de Manutenção",
      icon: FiBriefcase,
      path: "/dashboard/notaPlanoManutencao",
    },
  ];
